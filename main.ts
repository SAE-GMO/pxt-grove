...
namespace grove {
   ...
   /**
    ...
    export function sendToDefaultThinkSpeak(apiKey: string, field1: number, field2: number, field3: number, field4: number, field5: number, field6: number, field7: number, field8: number) {
        sendToThinkSpeak("api.thingspeak.com", apiKey, field1, field2, field3, field4, field5, field6, field7, field8);
    }

    /**
     * Send data to (custom) ThinkSpeak
     */
    //% block="Send Data to your (custom) ThinkSpeak Channel|url %url|Write API Key %apiKey|Field1 %field1|Field2 %field2|Field3 %field3|Field4 %field4|Field5 %field5|Field6 %field6|Field7 %field7|Field8 %field8"
    //% group="UartWiFi"
    //% url.defl="api.thingspeak.com"
    //% apiKey.defl="your Write API Key"
